<template>
  ...
  >
    ...
    <div
      class="relativ w-full overflow-hidden after:clear-both after:block after:content-['']"
    >
      ...
      >
        <img
          src="../assets/Silicone-Sealant-1-scaled.webp"
          class="block w-full h-[600px] object-cover"
        />
      </div>
      ...
      >
        <img
          src="../assets/thermal-paste-image.avif"
          class="block w-full h-[600px] object-cover"
        />
      </div>
